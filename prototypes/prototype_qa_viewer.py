  ...
  <div id="variant-c" class="variant-view">
    ...
    <div class="presentation-sidebar">
      ...
      <div class="slide-deck-card">
        <div class="slide-deck-title">1. Multi-Anchor Euclidean Partition</div>
        <div class="slide-deck-body">
          Replaced fragile heuristic cutting planes with 3D multi-anchor distance transforms.
          Achieved <strong>0% septal bleed</strong> and 100% primary connected component purity across the AV groove.
        </div>
      </div>
      
      <div class="slide-deck-card" style="border-left-color:var(--accent-purple);">
        <div class="slide-deck-title">2. Partial Volume Fat Recovery</div>
        <div class="slide-deck-body">
          Adaptive Gaussian thresholding clamped at 0.0 HU recovers the thin 1–2 voxel epicardial fat boundary layer,
          yielding <strong>+23.7% biometric volume</strong> compared to the historical -30 HU clip.
        </div>
      </div>
      
      <div class="slide-deck-card" style="border-left-color:var(--accent-green);">
      ...
      <button class="btn btn-primary" style="margin-top:auto;" id="btn-download-slide">
        <span>📑</span> Export Clinical Summary Report
      </button>
    </div>
  </div>
